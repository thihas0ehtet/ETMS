...
class PdfGeneratorView extends StatefulWidget {
  const PdfGeneratorView({super.key});

  @override
  State<PdfGeneratorView> createState() => _PdfGeneratorViewState();
}

class _PdfGeneratorViewState extends State<PdfGeneratorView> {
  @override
