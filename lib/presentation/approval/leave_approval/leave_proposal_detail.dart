...
class LeaveProposalDetailView extends StatefulWidget {
  ...
  @override
  State<LeaveProposalDetailView> createState() =>
      _LeaveProposalDetailViewState();
}
...
class _LeaveProposalDetailViewState extends State<LeaveProposalDetailView> {
  ...
  void getData() async {
    ...
    await controller.getLeaveProposalDetailList(
        notifyId: sysId, proposalId: widget.proposalId);
  ...
  getLeaveTypes() async {
    ...
    setState(() {
      ...
      typeStringList.addAll(leaveController.leaveTypes
          .map((element) => element.leaveTypeName.toString())
          .toList());
    });
    for (var i = 0; i < leaveController.leaveTypes.length; i++) {
      if (leaveController.leaveTypes[i].leaveTypeName
              .toString()
              .toLowerCase() ==
    ...
    if (isFileUploadable) {
      await leaveController.getLeavePhoto(
          id: dataList[0].leaveProposeID.toString());
      setState(() {
                      ...
                      children: [
                        Column(
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                Text(
                                  dataList[0].leaveTypeName.toString(),
                                  style: latoSemibold,
                                ).paddingOnly(right: 10),
                                Flexible(
                                    child: Text(
                                  DateTime.parse(
                                          dataList[0].leaveDate.toString())
                                      .dMY()
                                      .toString(),
                                  style: latoRegular.copyWith(fontSize: 14),
                                )),
                              ],
                            ).paddingOnly(bottom: 10),
                            Row(
                              ...
                              children: [
                                ...
                                Flexible(
                                    child: Text(
                                  DateTime.parse(
                                          dataList[0].leaveStartDate.toString())
                                      .dMY()
                                      .toString(),
                                  style: latoRegular.copyWith(fontSize: 14),
                                )),
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Flexible(
                                    child: Text(
                                  DateTime.parse(
                                          dataList[0].leaveEndDate.toString())
                                      .dMY()
                                      .toString(),
                                  style: latoRegular.copyWith(fontSize: 14),
                                )),
                        ...
                        Column(
                          ...
                          children: [
                            ...
                            Text(
                              dataList[0].remark.toString() == '' ||
                                      dataList[0].remark.toString() == 'null'
                                  ? '-'
                                  : dataList[0].remark.toString(),
                              style: latoRegular.copyWith(fontSize: 14),
                            ),
                        ...
                        if (isFileUploadable &&
                            leavePhoto.isNotEmpty &&
                            leavePhoto.toString() != 'null')
                          Column(
                            children: [
                              Row(
                                mainAxisAlignment:
                                  ...
                                  GestureDetector(
                                    onTap: () {
                                      Uint8List bytes = base64
                                          .decode(leavePhoto.split(',').last);
                                      Navigator.of(context).push(
                                          PhotoViewOverlay(imageBytes: bytes));
                                    },
                                    child: Card(
                                            ...
                                            actions: [
                                              ...
                                              CupertinoDialogAction(
                                                ...
                                                onPressed: () async {
                                                  Navigator.pop(context);
                                                  Navigator.pop(context);
                                                  List<LeaveProposalDetailRequest>
                                                      leaveProposalDetailList =
                                                      [];
                                                  for (var i = 0;
                                                      i <
                                                          controller
                                                    ...
                                                    if (checkBoxList[i] ==
                                                        true) {
                                                      leaveProposalDetailList.add(LeaveProposalDetailRequest(
                                                          leaveProposeDetailID: dataList[i]
                                                              .leaveProposeDetailID,
                                                          leaveProposeID: dataList[i]
                                                              .leaveProposeID,
                                                          leaveTypeID: dataList[i]
                                                              .leaveTypeID,
                                                          leaveDate: DateFormat(
                                                              ...
                                                              .format(
                                                                  DateTime.parse(
                                                                      dataList[i]
                                                                          .leaveDate!)),
                                                          leaveDuration: dataList[i]
                                                              .leaveDuration,
                                                          leaveAMPM: dataList[i]
                                                                  .leaveAMPM!
                                                                  .startsWith('1')
                                                              ? 1
                                                              : 2,
                                                      ...
                                                      leaveStartDate:
                                                          DateFormat('dd-MMM-yyyy')
                                                              .format(DateTime.parse(
                                                                  dataList[0]
                                                                      .leaveStartDate!)),
                                                      leaveEndDate: DateFormat(
                                                              'dd-MMM-yyyy')
                                                          .format(DateTime.parse(
                                                              dataList[0].leaveEndDate!)),
                                                      duration: duration,
